export const DiagnosisHistoryData = [
  {
    id: 0,
    title: "Respiratory Rate",
    icon: `<svg id="respiratory_rate" data-name="respiratory rate" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="96" height="96" viewBox="0 0 96 96">
              <defs>
    ...
    link: "respiratory_rate",
    unit: "bpm"
  },
  {
    id: 1,
    title: "Temperature",
    icon: `<svg id="temperature" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="96" height="96" viewBox="0 0 96 96">
              <defs>
                <clipPath id="clip-path">
  ...
  },
  {
    id: 2,
    title: "Heart Rate",
    icon: `<svg id="HeartBPM" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="96" height="96" viewBox="0 0 96 96">
              <defs>
                <clipPath id="clip-path">
...
export const ArrowIcons = {
  lowerThan: `<svg xmlns="http://www.w3.org/2000/svg" width="9.999" height="5.479" viewBox="0 0 9.999 5.479">
  ...
  higherThan: `<svg xmlns="http://www.w3.org/2000/svg" width="10" height="5.479" viewBox="0 0 10 5.479">
...
export const systolicDiastolicData = [
  {
    id: 0,
    title: "Systolic",
    link: "systolic"
